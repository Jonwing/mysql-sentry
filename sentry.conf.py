...
DATABASES = {
    'default': {
        ...
        'NAME': (
            env('SENTRY_DB_NAME') or env('POSTGRES_ENV_MYSQL_USER') or 'sentry'
        ),
        'USER': (
            env('SENTRY_DB_USER') or env('POSTGRES_ENV_MYSQL_USER') or 'sentry'
        ),
        'PASSWORD': (
            env('SENTRY_DB_PASSWORD') or env('POSTGRES_ENV_MYSQL_PASSWORD') or ''
        ),
        'HOST': mysql,
        'PORT': (
